...
class Files
{
    ...
    public static function createFile($aimUrl, $overWrite = false)
    {
        if (file_exists($aimUrl) && $overWrite == false) {
            ...
            Files:: unlinkFile($aimUrl);
        }
        $aimDir = dirname($aimUrl);
        Files:: createDir($aimDir);
        touch($aimUrl);
        return true;
    }
    ...
    public static function moveDir($oldDir, $aimDir, $overWrite = false)
    {
        ...
        while (false !== ($file = readdir($dirHandle))) {
            ...
            if (!is_dir($oldDir . $file)) {
                Files:: moveFile($oldDir . $file, $aimDir . $file, $overWrite);
            } else {
                Files:: moveDir($oldDir . $file, $aimDir . $file, $overWrite);
            }
        }
        closedir($dirHandle);
        return rmdir($oldDir);
    ...
    public static function unlinkDir($aimDir)
    {
        ...
        while (false !== ($file = readdir($dirHandle))) {
            ...
            if (!is_dir($aimDir . $file)) {
                Files:: unlinkFile($aimDir . $file);
            } else {
                Files:: unlinkDir($aimDir . $file);
            }
        }
        closedir($dirHandle);
        return rmdir($aimDir);
    ...
    public static function copyDir($oldDir, $aimDir, $overWrite = false)
    {
        ...
        while (false !== ($file = readdir($dirHandle))) {
            ...
            if (!is_dir($oldDir . $file)) {
                Files:: copyFile($oldDir . $file, $aimDir . $file, $overWrite);
            } else {
                Files:: copyDir($oldDir . $file, $aimDir . $file, $overWrite);
            }
        }
